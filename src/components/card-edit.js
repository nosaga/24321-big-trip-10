...
const createCardEditTemplate = (trip, index) => {
  ...
  const startMonthNaming = monthNames[dateFrom.getMonth()];
  ...
  return `<li class="trip-days__item  day">
      <div class="day__info">
        ...
        <time class="day__date" datetime="${startYear + `-` + startMonthDigit + `-` + startDate}">${startMonthNaming} ${startDate}</time>
      </div>
...
export default class CardEditComponent extends AbstractComponent {
  ...
  getTemplate() {
    return createCardEditTemplate(this._trip, this._index);
  }
}
